"""
Example: How to call the uk-business-licence-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/uk-business-licence-scraper
...
def run_actor():
    """Run the uk-business-licence-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/uk-business-licence-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.gov.uk/find-licences"}],
            "maxItems": 20,
